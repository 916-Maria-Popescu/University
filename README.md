...
<h2 title = "03.2021-05.2021"> Semester 2 </h2>
	<h3> <a href = "https://github.com/916-Maria-Popescu/Data-Structures-and-Algorithms"> Data Structures and Algorithms </a> </h3>
		<pre> - design and implement different applications starting fromthe use of abstract data types
		      -	process data stored in different data structures
		      -	choose the abstract data type and data structure bestsuited for a given application </pre>
